    ...
    <ul class="px-2 py-6 flex flex-col gap-3 overflow-y-hidden hover:overflow-y-auto h-full">
            ...
            <ul class="">
                ...
                <li class="flex-col justify-between bg-slate-300">
                    ...
                    <ul class="bg-slate-400">
                        ...
                        <li class="">
                            <button type="button"
                                class="py-4 flex justify-between w-full bg-slate-300 cursor-pointer px-3">
        ...
        <li class="flex-col items-center justify-between mx-3">
            ...
            <ul class="bg-slate-200">
                ...
                <li class="flex-col justify-between">
                    <button type="button"
                        class="px-3 w-full flex justify-between items-center py-4 text-start transition bg-green-600 hover:bg-green-650 text-white cursor-pointer"
                        href="#imunisasi">
                    ...
                    <ul class="bg-slate-400 ">
                        ...
                        <li class="bg-slate-500">
                            <button type="button"
                                class="px-3 py-4 flex justify-between w-full bg-slate-300 cursor-pointer items-center">
                                <p class="">Laporan Manual</p>
                                @include('icons.PlusIcon')
                            </button>
                            <ul class="bg-red-500">
