<x-layout>
    <div class="px-6 py-6 h-full flex flex-col gap-5 overflow-y-scroll">
        <h1 class="url-route ">Program Pencegahan dan Pengendalian Penyakit / Sub. Bagian Imunisasi / Laporan Manual / Jumlah Total Dan Presentase WUS (Hamil + Tidak Hamil) Diimunisasi TD</h1>
        <div class="border border-gray-100"></div>
        <h1 class="text-2xl font-bold text-center mb-5 mt-5 text-gray-700">Jumlah Total Dan Presentase WUS (Hamil + Tidak Hamil) Diimunisasi TD</h1>
        <div>
            ...
            <div id="popupForm" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center hidden">
                <div class="bg-white p-6 rounded-lg w-1/2 shadow-lg">
                    <h1 class="text-2xl font-bold mb-4 text-center">Jumlah Total Dan Presentase WUS (Hamil + Tidak Hamil) Diimunisasi TD</h1>
