<x-layout>
    <div class="px-6 py-6 h-full flex flex-col gap-5 overflow-y-scroll">
        <h1 class="url-route">Program Pencegahan dan Pengendalian Penyakit / Sub. Bagian Imunisasi / Laporan Manual / Sasaran Baduta</h1>
            ...
            <div class="bg-white p-6 rounded-lg w-1/2 shadow-lg">
                ...
                <form action="#" method="POST">
                    ...
                    <div class="mb-4 flex space-x-4">
                        <div class="w-1/2">
                            <div class="mb-4">
                                <label for="jumlahLakiLaki" class="block text-gray-700">Jumlah Imunisasi Baduta Laki-Laki</label>
                                <input type="number" id="jumlahLakiLaki" name="jumlahLakiLaki" class="w-full border p-3 rounded-lg" value="1" required>
                            </div>
                        </div>
                        <div class="w-1/2">
                            <div class="mb-4">
                                <label for="jumlahPerempuan" class="block text-gray-700">Jumlah Imunisasi Baduta Perempuan</label>
