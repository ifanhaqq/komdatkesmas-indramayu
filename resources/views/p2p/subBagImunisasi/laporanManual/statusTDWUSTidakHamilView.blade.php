<x-layout>
    <div class="px-6 py-6 h-full flex flex-col gap-5 overflow-y-scroll">
        <h1 class="url-route ">Program Pencegahan dan Pengendalian Penyakit / Sub. Bagian Imunisasi / Laporan Manual / Status TD WUS Tidak Hamil</h1>
        <div class="border border-gray-100"></div>
        <h1 class="text-2xl font-bold text-center mb-5 mt-5 text-gray-700">Status TD WUS Tidak Hamil</h1>
        <div>
