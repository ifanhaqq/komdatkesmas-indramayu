<x-layout>
    <div class="px-6 py-6 h-full flex flex-col gap-5 overflow-y-scroll">
        <h1 class="url-route ">Program Pencegahan dan Pengendalian Penyakit / Sub. Bagian Imunisasi / Laporan Manual / Status WUS (Hamil + Tidak Hamil) Diimunisasi TD</h1>
        <div class="border border-gray-100"></div>
        <h1 class="text-2xl font-bold text-center mb-5 mt-5 text-gray-700">Status WUS (Hamil + Tidak Hamil) Diimunisasi TD</h1>
        <div>
            ...
            <div class="flex gap-3 justify-between mt-5">
                ...
                <div id="popupForm" class="fixed inset-0 justify-center items-center hidden">
                    ...
                    <div class="absolute bg-white p-6 rounded-lg w-1/2 shadow-lg top-20 bottom-20 overflow-y-auto">
                        <h1 class="text-2xl font-bold mb-4 text-center">Status WUS (Hamil + Tidak Hamil) Diimunisasi TD</h1>
