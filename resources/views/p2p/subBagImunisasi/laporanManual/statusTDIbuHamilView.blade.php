<x-layout>
    <div class="px-6 py-6 h-full flex flex-col gap-5 overflow-y-scroll">
        <h1 class="url-route ">Program Pencegahan dan Pengendalian Penyakit / Sub. Bagian Imunisasi / Laporan Manual / Status TD Ibu Hamil</h1>
        <div class="border border-gray-100"></div>
        <h1 class="text-2xl font-bold text-center mb-5 mt-5 text-gray-700">Status TD Ibu Hamil</h1>
        <div>
            ...
            <div id="popupForm" class="fixed inset-0 justify-center items-center hidden">
                ...
                <div class="absolute bg-white p-6 rounded-lg w-1/2 shadow-lg top-20 bottom-20 overflow-y-auto">
                    <h1 class="text-2xl font-bold mb-4 text-center">Status TD Ibu Hamil</h1>
                    <form action="#" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="sasaranBumil" class="block text-gray-700">Sasaran Bumil</label>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="jumlah" name="jumlah" class="w-full border mt-3 p-3 rounded-lg" required>
                        </div>
        ...
        <table class="table-auto w-full border-collapse">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="border px-4 py-2" rowspan="3">Sasaran  Bumil</th>
        ...
        <table class="table-auto w-full border-collapse">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="border px-4 py-2">Sasaran Bumil</th>
