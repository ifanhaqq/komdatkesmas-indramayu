<x-layout>
    <div class="px-6 py-6 h-full flex flex-col gap-5 overflow-y-scroll">
        <h1 class="url-route ">Program Pencegahan dan Pengendalian Penyakit / Sub. Bagian Imunisasi / Laporan Manual / Jumlah Dan Presentase Ibu Hamil Diimunisasi</h1>
        <div class="border border-gray-100"></div>
        <h1 class="text-2xl font-bold text-center mb-5 mt-5 text-gray-700">Jumlah Dan Presentase Ibu Hamil Diimunisasi</h1>
        <div>
            ...
            <div id="popupForm" class="fixed inset-0 justify-center items-center hidden">
                ...
                <div class="absolute bg-white p-6 rounded-lg w-1/2 shadow-lg top-20 bottom-20 overflow-y-auto">
                    <h2 class="text-2xl font-bold mb-4 text-center">Jumlah Dan Presentase Ibu Hamil Diimunisasi</h2>
