<x-layout>
    <div class="border px-6 py-6 h-full flex flex-col gap-5 overflow-y-scroll">
        <h1 class="url-route border">/ test / p2p / sub-bagian-imunisasi / laporan-manual / jumlah-dan-presentasi-ibu-hamil-diimunisasi</h1>
        ...
        <table class="table-auto w-full border-collapse">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="border-b px-4 py-2" colspan="4">Jumlah dan Presentase Ibu Hamil Diimunisasi</th>
                </tr>
                <tr>
